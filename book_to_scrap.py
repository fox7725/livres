...
tableau = soup.find("table", class_="table-striped")
...
category = soup.select(".breadcrumb > li")
...
image_url = soup.select(".active > img")
...
review_rating = soup.find("p", {"class": "star-rating"}).get("class")
